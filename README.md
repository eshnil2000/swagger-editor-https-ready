# Swagger Editor swagger-editor-https-ready
### Major change
Edited index.html to reference sources relative to protocol
for example:
#### THIS
```
...
#### CHANGED TO
```
<link href="//mydomain.co/api-design/dist/swagger-editor.css" rel="stylesheet">
```

#### ASSUMING Apache vhost file looks like the following, and swagger is started on port 8082:
https://github.com/eshnil2000/SSL-Apache2-VirtualHost
```
<IfModule mod_ssl.c>
<VirtualHost *:443>
